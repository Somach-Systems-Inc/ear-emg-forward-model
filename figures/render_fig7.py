...
def main(argv=None) -> int:
    ...
    rc.assert_anonymised("fig7_suprahyoid_field", True)
    if not rc.PAPER_MODE:
        fig.suptitle("Fig 7 · Suprahyoid sensitivity field, retroauricular montage",
    ...
    rc.save(fig, "fig7_suprahyoid_field", prov, a.outdir)
    return 0
