...
\author{Carl Vincent Kho \\ Independent researcher; Somach Systems, Inc., San Francisco, CA, USA \\ carl@somach.life \textperiodcentered{} https://somach.life}
\date{}
...
\textbf{{[}−1.453, +5.458{]}} and only \textbf{50.5 per cent} of the four-site
...
\textbf{The interval is computed exactly, not sampled.} Fourteen candidate ear sites
...
\(\rho\) between −0.928 and −0.986 and p below 0.01 in all seven cases
{[}\texttt{results/04t\_correlation\_robustness.csv}{]}. The strength of that
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{fig5_complementarity_map.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth,height=0.42\textheight,keepaspectratio]{fig6_suprahyoid_field.pdf}
