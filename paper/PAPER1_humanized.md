...
back reliably in exchange. What remains a design lever is placement, a four-site
cluster chosen by anatomical target beats an arbitrary draw from the same
candidates. The homogeneous-conductor control locates what anatomical detail is
needed for — montage assignment is recoverable without it, magnitudes are not.
